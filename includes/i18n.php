...
$GLOBALS['I18N'] = [
    'en' => [
        ...
        'group_active' => 'Running / Upcoming',
        'filter_by_name' => 'Filter by name',
        'flt_name' => 'Name',
        'browse_search_placeholder' => 'Search for your favourite show',
        ...
        'mark_all_watched' => '✅ Mark All Episodes Watched', 'mark_all_unwatched' => '❌ Mark All Episodes Unwatched',
    ...
    'tr' => [
        ...
        'nav_browse' => 'Dizilere Gözat', 'nav_upcoming' => 'Yaklaşan Bölümler',
        ...
        'group_active' => 'Devam Eden / Yakında',
        'filter_by_name' => 'İsme göre filtrele',
        'flt_name' => 'İsim',
        'browse_search_placeholder' => 'Favori dizini ara',
